...
The info frame box and Categories bar are located in the footer section of the page. The Categories bar has four buttons: 'Same Colour', 'Artist', 'Same Epoch', and 'Objects'.
